...
<main>
        ...
        <div class="driver-info-container">
            ...
            <section class="vehicle-form">
                <form action="../PHP/traitement-vehicule.php" method="POST" novalidate>
                    ...
                    <div class="form-section form-group">
                        <label>Marque :</label>
                        <select class="brand" name="marque">
                    ...
                    <div class="form-section form-group">
                        <label>Modèle :</label>
                        <select class="model" name="modele">
                    ...
                    <div class="form-section form-group">
                        ...
                        <select class="fuel" name="carburant">
                    ...
                    <div class="form-section form-group">
                        ...
                        <input type="number" class="seats" name="places" min="1" max="8">
                    </div>

                    <hr>

                    <div class="form-section pets-container">
                    ...
                    <div class="form-section smoking-container">
                        <p>Fumeur :</p>
    ...
    <div class="vehicle-buttons">
        ...
        <button type="button" id="removeVehicleBtn">Supprimer le dernier véhicule</button>
    </div>
</main>
