...
<main>
    ...
    <div class="details-trajet">
        ...
        <!-- Section conducteur sur toute la largeur -->
        ...
        <!-- Conteneur pour plan et passagers côte à côte -->
        <div class="plan-passengers-container">
            <!-- Détails du trajet -->
            ...
            <section class="passenger">
                ...
                <article class="passenger-card">
                    <img src="../../IMAGES/theo.jpg" alt="Photo de Théo" class="passenger-photo">
                    <div class="passenger-info">
...
<script src="../JS/USR-details-trajets.js"></script>
</main>
